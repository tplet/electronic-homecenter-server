...
#ifndef HOMECENTER_SERVER_REPOSITORY_SENSORREPOSITORY_H
#define HOMECENTER_SERVER_REPOSITORY_SENSORREPOSITORY_H
...
namespace repository
{
    ...
    public:
         ...
         * Constructor
         */
        SensorRepository(DatabaseManager * databaseManager)
        {
...
#endif //HOMECENTER_SERVER_REPOSITORY_SENSORREPOSITORY_H
